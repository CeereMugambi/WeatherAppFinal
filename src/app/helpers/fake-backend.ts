    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function register() {
            ...
            if (account.id === 1) {
                ...
                account.role = IRole.Admin;
            } else {
                account.role = IRole.User;
            }
        ...
        function getAccountById() {
            ...
            if (account.id !== currentAccount().id && !isAuthorized(IRole.Admin)) {
                return unauthorized();
            }
        ...
        function createAccount() {
            if (!isAuthorized(IRole.Admin)) return unauthorized();
